...
//test
//$SECURE_SECRET = "D99A5733CA2A7A2EC8B78474DC09A43A";
//$SECURE_SECRET = "F5A37F3EA01D99BFADC3E09C4FAA9E7A";
$SECURE_SECRET = "F6E3B003479B694A7A3ACD58A2761056";
...
$reservationId = $_POST['vpc_MerchTxnRef'];
...
$roomUpdate = new RoomUpdateService();
$hasRooms = $roomUpdate->checkRoomAvailabilityFinal($_SESSION['BRC'],$_SESSION['propertyCode']);

if(!$hasRooms){
    $errorPageUrl = "../view/justSold.php";
    header('Location:' . $errorPageUrl);
    exit();
}else{
    $confirmationService = new confirmationService();
   $reservedRooms = $confirmationService->getReservedRoomDetails($reservationId);
    $roomUpdate->updateAndConfirmRoomAvailability($reservedRooms,$_SESSION['propertyCode'],"M");
}
