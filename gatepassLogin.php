...
<html lang="en">
    <head>
        ...
        <title>Personal Snippet - Google style login extended (with HTML5 LocalStorage) - Bootsnipp.com</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="card card-container">
                ...
                <h3>Sapro Asset - Gatepass</h3>
                <img id="profile-img" class="profile-img-card" src="http://www.communitypass.net/assets/images/icons/icon-ID.png" />
                <p id="profile-name" class="profile-name-card"></p>
                <form class="form-signin" method="post" action="gatepassView.php">
